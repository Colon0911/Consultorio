...
public class ControladorCitas {
  ...
  public void guardarCita(frm_Citas frmcitas){
     ...
     cita= new Citas(0, Integer.parseInt(frmcitas.getHoras().getSelectedItem().toString()),paciente,medico, fecha);
     cita.getPaciente().setId(frmcitas.getTxtCedulaPaciente().getText());
     cita.getMedico().setId(frmcitas.getTxtCedulaMedic().getText());
    ...
    public boolean buscarMedico(frm_Citas frmcitas){
        ...
        medico= new Medicos();
        medico.setId(frmcitas.getTxtCedulaMedic().getText());
 ...
 */
   ...
   */
     ...
     cita= new Citas(frmcitas.getId(), Integer.parseInt(frmcitas.getHoras().getSelectedItem().toString()), paciente, medico, fecha);
     cita.getMedico().setId(frmcitas.getTxtCedulaMedic().getText());
     cita.getPaciente().setId(frmcitas.getTxtCedulaPaciente().getText());
